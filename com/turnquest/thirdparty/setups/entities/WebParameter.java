...
@Entity
@Table(name = "gin_web_parameters", schema = "TQ_GIS")
public class WebParameter implements Serializable
{
    @Id
    @Column(name = "param_code", nullable = false)
    @SequenceGenerator(name = "GIN_WEB_PARAM_CODE_SEQ", schema = "TQ_GIS", allocationSize = 1)
    ...
    public boolean equals(final Object o) {
        ...
        final WebParameter other = (WebParameter)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof WebParameter;
    }
    ...
    public String toString() {
        return "WebParameter(code=" + this.getCode() + ", name=" + this.getName() + ", value=" + this.getValue() + ", status=" + this.getStatus() + ", desc=" + this.getDesc() + ")";
    }
}
