...
@Entity
@Table(name = "tqc_parameters", schema = "TQ_CRM")
public class Parameter implements Serializable
{
    @Id
    @Column(name = "param_code", nullable = false)
    @SequenceGenerator(name = "TQC_PARAM_CODE_SEQ", schema = "TQ_CRM", allocationSize = 1)
    ...
    public String toString() {
        return "Parameter(code=" + this.getCode() + ", name=" + this.getName() + ", value=" + this.getValue() + ", status=" + this.getStatus() + ", desc=" + this.getDesc() + ")";
    }
}
